...
AMIDEWINx64.exe /PBM %random%%random%%random%
AMIDEWINx64.exe /PBS %random%%random%%random%
AMIDEWINx64.exe /PS %random%%random%%random%
AMIDEWINx64.exe /PT %random%%random%%random%
cls
set /A RND=%RANDOM% %% 8889 + 1111
reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Cryptography /v MachineGuid /T REG_SZ /d "{Cru5Ch-142-24946-3062-533%RND%}" /f
@echo off
set /A RND=%RANDOM% %% 8889 + 1111
reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Cryptography /v GUID /T REG_SZ /d "{Cru5Ch-142-24946-3062-533%RND%}" /f
@echo off
set /A RND=%RANDOM% %% 8889 + 1111
Reg.exe add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware Profiles\0001" /v "HwProfileGuid" /t REG_SZ /d "{Cruch-12A1-123B-A12C-123A123B%RND%}" /f 
@echo off
set /A RND=%RANDOM% %% 8889 + 1111
Reg.exe add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware Profiles\0001" /v "GUID" /t REG_SZ /d "{Cruch-12A1-123B-A12C-123A123B%RND%}" /f 
@echo off
